export default {
    ...
    projects: require('@/assets/images/projectIcon.png'),
    fuel: require('@/assets/images/fuelIcon.png'),
    bunker: require('@/assets/images/bunkerIcon.png'),
    hr: require('@/assets/images/hrIcon.png'),
}